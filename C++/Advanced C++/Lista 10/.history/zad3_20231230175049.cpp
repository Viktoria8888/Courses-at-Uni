...
int main() {
    std::string inputFile = "path/to/input_utf8.txt"; // Path to your UTF-8 encoded file
    std::string outputUtf32 = "path/to/output_utf32.txt";
    std::string outputIso88592 = "path/to/output_iso88592.txt";
