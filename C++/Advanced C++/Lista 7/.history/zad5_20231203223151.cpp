...
// Function to compute the Riemann zeta function at a given complex number z
...
int main()
{
    ...
    // Store values for real and imaginary parts separately
    std::vector<double> real_values;
    std::vector<double> imag_values;

    for (int i = 0; i < num_points; ++i)
    {
        double t = i * step - num_points / 2 * step; // Center around zero
